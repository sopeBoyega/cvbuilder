"use client"
import { Div, Center, TextArea } from "../addons/csml"
import BaseHOC from "../addons/HOC"
import SliderHOC from "../addons/Slider"
import React from "react"
export default function StepPage(){
    var slider = new SliderHOC({blockLoop:true,slideTime:1000})
                    ...
                    <slider.Render self={slider}>
                        <Div display="flex" flexDirection="column" gap="20px">
                            ...
                            <Div display="grid" gap="20px" gridTemplateColumns="1fr 1fr">
                                <yesJobHaveOne.Render self={yesJobHaveOne} textAlign="center" onClick={()=>{
                                    haveJobDes.style.display("flex")
                                ...
                                <noJobHaveOne.Render self={noJobHaveOne} textAlign="center" onClick={()=>{
                            ...
                            <haveJobDes.Render flexDirection="column" gap="20px" display="none" self={haveJobDes}>
                            ...
                            <Div display="flex" flexDirection="column" gap="20px">
                                ...
                                <Div display="grid" gap="20px" gridTemplateColumns="1fr 1fr">
                                    <yesCVHaveOne.Render self={yesCVHaveOne} textAlign="center" onClick={()=>{
                                        haveCVDes.style.display("flex")
                                    ...
                                    <noCVHaveOne.Render self={noCVHaveOne} textAlign="center" onClick={()=>{
                                ...
                                <haveCVDes.Render marginInline="20px" flexDirection="column" gap="20px" display="none" self={haveCVDes}>
                                    <Div fontSize="15px" color="rgba(156, 163, 175, 1)">Upload your CV in PDF or Word format:</Div>
                                    <input type="file" name="" id="" hidden/>
                                    <Div paddingBlock = "30px" borderRadius="10px" border="2px solid rgba(65, 75, 91, 1)" display="grid" placeItems="center" gap="10px">
                                        <Center>
                                        ...
                                        <Div fontSize="14px">Supported formats: PDF, DOC, DOCX</Div>
                                    </Div>
                                </haveCVDes.Render>
