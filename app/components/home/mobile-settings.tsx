  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col  gap-5 p-6 rounded-xl w-full">
        <div>
          <label className="text-white mb-2 font-[600] block">Block Type</label>
          ...
          <div className="flex justify-evenly items-center gap-2">
            {blockColors.map((color, index) => (
              <div
                ...
                className="w-[40px] h-[40px] rounded-full place-content-center place-items-center"
        ...
        <div className="flex flex-col gap-5 mt-7">
          <div>
            ...
            <div className="relative">
              ...
              />
              <select className=" px-4 py-2 bg-white text-[#475569] font-[500] rounded-full border-none focus:ring-0 focus:border-none w-full">
                <option>heading-2</option>
                <option>Text</option>
                <option>Text</option>
              </select>
      ...
      <hr className="w-full border-[1px] border-white mt-5" />
       <div className="w-full items-center justify-center flex-col gap-3 place-items-center place-content-center p-4">
        <button type="button" className="border-none bg-[#2563EB]  w-[90%] rounded-full  flex items-center justify-center p-2">
            Save Changes   <Check/>
        </button>
        <button type="button" className="border-[1px] border-white  w-[90%] flex items-center rounded-full justify-center p-2 mt-4">
            Discard Changes  <X/>
        </button>
       </div>
    </div>
