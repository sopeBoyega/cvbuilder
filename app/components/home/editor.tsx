  ...
  return (
    ...
    <div className="flex flex-col w-[70%] gap-7  ">
      <div className="flex justify-between items-center bg-white p-4 rounded-lg">
        <p className="text-black font-[600] text-[17px]">Head of Sale position</p>
        <IconItem name="edit" color=""/>
      </div>

    <div className="p-1 bg-gray-50 border w-full  place-self-center bg-transparent border-gray-300 rounded-3xl shadow-sm">
      ...
      <MenuContent>
        ...
        <button
          ...
          className={`p-2 rounded ${
            editor?.isActive("bold") ? "bg-[#2563EB] text-white" : "text-white"
          }`}
        >
          <LuBold />
        </button>
        <button
          ...
          className={`p-2 rounded ${
            editor?.isActive("italic") ? "bg-[#2563EB] text-white" : "text-white"
          }`}
        >
          <LuItalic />
        </button>
        ...
        <button
          ...
          className={`p-2 rounded ${
            editor?.isActive("strike") ? "bg-[#2563EB] text-white" : "text-white"
          }`}
        >
          <LuStrikethrough />
        </button>
        <button
         onClick={() => editor?.chain().focus().toggleCode().run()}
          className={`p-2 rounded ${
            editor?.isActive("code") ? "bg-[#2563EB] text-white" : "text-white"
          }`}
        >
          <LuCode/>
        </button>
